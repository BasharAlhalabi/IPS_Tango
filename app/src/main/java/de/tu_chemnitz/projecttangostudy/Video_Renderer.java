...
/**
 * Created by Halabi on 21.04.2017.
 */

public class Video_Renderer implements GLSurfaceView.Renderer {
    private static final String TAG = Video_Renderer.class.getSimpleName();
    ...
    public Video_Renderer(RenderCallback callback) {
    ...
    private void setTextureCoords(float[] textureCoords) {
        ...
        if (mVbos != null) {
            ...
            // Populate it.
            GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, 4 * 2 * Float.SIZE / 8, mTexCoord, GLES20.GL_STATIC_DRAW); // texcoord of floats.
        }
    }
