...
public class AdfUuidListViewActivity extends Activity implements SetAdfNameDialog.CallbackListener {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (!mIsTangoReady) {
            Toast.makeText(this, "Tango is not ready!", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void importAdf(String uuid) {
        try {
            ...
            Toast.makeText(this, "ADF already exists at Tango!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void exportAdf(String uuid) {
        try {
            ...
            Toast.makeText(this, "ADF already exists at App-Space!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void deleteAdfFromTangoSpace(String uuid) {
        try {
            ...
            Toast.makeText(this, "ADF -UUID not found!", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        try {
            ...
            for (String uuid : fullUuidList) {
                ...
                try {
                    ...
                    Toast.makeText(this, "Tango Err!", Toast.LENGTH_SHORT).show();
                }
